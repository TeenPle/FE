...
gradle.taskGraph.whenReady {
    ...
    if (isReleaseTask && (!keystorePropertiesFile.exists() || missingSigningKeys.isNotEmpty())) {
        throw org.gradle.api.GradleException(
            "Missing release signing configuration. Create android/key.properties with storeFile, storePassword, keyAlias, and keyPassword before building a release."
        )
    }
}

android {
    namespace = "com.teenple.teenple_frontend"
    ...
    defaultConfig {
        applicationId = "com.teenple.teenple_frontend"
