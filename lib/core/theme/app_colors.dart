...
class AppColors extends ThemeExtension<AppColors> {
  ...
  @override
  AppColors copyWith({
    Color? pageBg, Color? cardBg, Color? inputBg,
    Color? subtleBg, Color? chipContainerBg, Color? tintBg,
    Color? replyBg, Color? highlightBg,
    Color? textPrimary, Color? textBody, Color? textSecondary,
    Color? textTertiary, Color? textMuted, Color? textHint, Color? textDisabled,
    Color? border, Color? borderStrong, Color? borderSubtle,
    Color? borderBlue, Color? divider, Color? dividerBlue,
    Color? iconPrimary, Color? iconSecondary, Color? iconMuted,
    Color? iconOnCard, Color? popupBg,
  }) {
    return AppColors(
