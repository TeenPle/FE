      ...
      case _LegalAgreementType.terms:
        return const [
          ...
          _LegalSectionData(
            title: '신고 및 제재',
            body:
                'TeenPle은 부적절한 콘텐츠와 악성 이용자에 대해 무관용 원칙을 적용합니다. 회원은 부적절한 콘텐츠 또는 이용자를 신고할 수 있으며, 운영자는 신고를 24시간 이내에 검토하고 위반이 확인되면 콘텐츠 삭제 또는 임시 숨김, 피드 노출 중단, 경고, 이용 제한, 영구 이용 제한, 계정 삭제 등의 조치를 할 수 있습니다.',
          ),
          _LegalSectionData(
            title: '탈퇴 및 복구',
            body:
      ...
      case _LegalAgreementType.privacy:
        return const [
          ...
          _LegalSectionData(
            ...
            body:
                '게시글, 댓글, 채팅, 이미지 등 회원이 작성하거나 전송한 콘텐츠는 서비스 제공 및 운영에 필요한 기간 동안 보관되며, 탈퇴 시 삭제 또는 비식별 처리될 수 있습니다. 회원은 개인정보 수집·이용에 대한 동의를 거부할 수 있으나, 필수 항목에 동의하지 않을 경우 회원가입, 학교 인증 및 서비스 이용이 제한될 수 있습니다.',
          ),
        ];
    }
  }
